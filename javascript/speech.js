...
// Checking Handless Mode is Enabled then continue recognition
...
recognition.onresult = (event) => {
    ...
    switch (transcript) {
        ...
        case "add email":
            ...
            temp_recognition.onresult = (e) => {
                let temp_transcript = e.results[e.results.length - 1][0].transcript;
                temp_transcript = temp_transcript.replace(".", "").toLowerCase().replace("com.", ".com").replace("enter the mail","").replace("email","").replace("theemail","").replace("theemail","").replace("enter","").replace("enter email","").replace("enter female","").replaceAll(" ","").replaceAll(",","");
                console.log(temp_transcript);
        ...
        case "add city":
            ...
            temp_recognition.onresult = (e) => {
                let temp_transcript = e.results[e.results.length - 1][0].transcript;
                temp_transcript = temp_transcript.replace(".", "").replace("Enter city ","").replace("Enter city","").replace("Enter City","").replace("Intercity","")
